...
setup(
    ...
    name='rise_of_machines',  # Required
    ...
    description='Path to the Machine Learning',  # Optional
    ...
    # above.
    author_email='Singamsetty.Sampath@gmail.com',  # Optional
    ...
    entry_points={  # Optional
        'console_scripts': [
            'rise_of_machines=rise_of_machines:main',
        ],
    },
    ...
    project_urls={  # Optional
        ...
        'Source': 'https://github.com/fpdevil/sampleproject/',
    },
)
